...
def buffer_to_array(buffer):
    ...
    print('buffer content type: ', type(buffer_content))
    print('buffer content: ', buffer_content)
    bytearray_obj = bytearray(buffer_content)
    print('bytearray_obj: ', bytearray_obj)
...
def create_thumbnail(key_image, min_size):
    ...
    print('Image after imdecode: ', image_array)
    print('shape Image after imdecode: ', image_array.shape)
    image_resized = resize_dimensions(image_array, min_size)
